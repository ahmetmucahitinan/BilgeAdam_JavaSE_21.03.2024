...
public class ConstructorOverloading {
    ...
    ConstructorOverloading(String country){    // Parametrized Constructor(Parametreli Constructor)
        this.country = country;
    }
    ...
    public static void main(String[] args) {
        ...
        /* 1. de NoArgsConstructor kullandık. İki field'ın değerini de nesneyi
        oluşturduktan sonra ayrı ayrı atadık*/
        ...
        /*
        2. de Parametrized Constructor kullandık. Field'lardan birinin değerini nesneyi oluştururken
        argüman olarak verdik(country), diğerini ise nesneyi oluşturduktan sonra, dışarıya atamasını yaptık.
        */

        ConstructorOverloading obj3 = new ConstructorOverloading("England","English");
        System.out.println(obj3.country + " " + obj3.language);
        /*
        3. de bütün field'ları Parameterized Constructor ile aldık. Dolayısıyla dışarıdan değer ataması
        yapmama gerek kalmadı. Nesneyi oluştururken içini de doldurdum. AllArgsConstructor denir buna.
        */
    }
}
