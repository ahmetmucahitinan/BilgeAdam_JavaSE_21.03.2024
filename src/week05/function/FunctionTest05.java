...
public class FunctionTest05 {
    public static void main(String[] args) {
        ...
        //İkisi de aynı işi yapıyor. İlkinde önce parseInt
        // metodunu çalıştırıp sonra andThen ile 2. metodu çalıştırıyoruz
        Function<String,Integer> parseIntIncrementExact = parseInt.andThen(incrementExact);
        ...
        Stream.of("-3","11","25","30","-1","-11")
                .map(parseIntIncrementExact).forEach(System.out::println);
