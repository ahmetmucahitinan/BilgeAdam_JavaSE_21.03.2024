...
public class Main {
    ...
    * 4 -> Notu 50' den düşük olan öğrencileri liste olarak dönen bir stream yazalım.
    * 5 -> Öğrencilerin isimlerini ve öğrencilerin notlarını yazdıran bir stream yazalım.
