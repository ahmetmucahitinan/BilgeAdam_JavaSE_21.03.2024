...
public class Main {
    public static void main(String[] args) {
        ...
        if (Size.EXTRALARGE.toString().equals("EXTRALARGE")){ //Buraya getirilen string değer değiştirilebilir
            System.out.println("toString.equals");
        }

        System.out.println("\n---name method---");
        if (Size.EXTRALARGE.name().equals("EXTRALARGE")){//Buraya getirilen string değer değiştirilemez. Final değerdir.
