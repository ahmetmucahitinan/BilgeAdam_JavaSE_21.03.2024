...
public class TreeMapExample02 {
    public static void main(String[] args) {
        ...
        System.out.println("Beginnig : " + numberMap);

        System.out.println("\nHigher"); // Girilen değerin üstündeki en küçük değeri ekrana yazar.
        System.out.println("higherKey(5) : " + numberMap.higherKey(5));
        System.out.println("higherEntry(5) : " + numberMap.higherEntry(5));

        System.out.println("\nLower"); //Girilen değerin altındaki en büyük değeri ekrana yazar
